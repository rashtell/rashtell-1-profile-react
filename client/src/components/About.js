            ...
            aboutLogistics.map((aboutLogistic, i) => {
                return (
                    <div
                        ...
                        <div
                            className={aboutLogistic.divClassName}>
                            <span
                                className={aboutLogistic.spanClassName}>
                                {aboutLogistic.value}+''
                        </span>
                            <br />
                            {aboutLogistic.name}
...
class Plans extends Component {
    render() {
        const { planProps, divClassName, divStyle, h3ClassName, heading } = this.props;
                ...
                <div
                    ...
                    {planProps.map((planProp, i) => {
                        return (
                            <div
                                key={i}
                                className={planProp.divClassName}>
                                <ul
                                    className={planProp.ulClassName}>
                                    ...
                                    <li
                                        className={planProp.price.liClassName}>
                                        <h2>
                                            {planProp.price.amount}
                                        </h2>
                                        <span
                                            className={planProp.spanClassName}>
                                            {planProp.price.duration}
                                        </span>
                                    </li>
                                    <li
                                        className={planProp.signUp.liClassName}>
                                        <a
                                            href={planProp.signUp.href}>
                                            <button
                                                className={planProp.signUp.buttonClassName}>
...
class Testimonials extends Component {
    render() {
        ...
        return (
            <div>
                <h3
                    className={testimonialsProps.h3ClassName}>
                ...
                {testimonialsProps.testimonialsPropsList.map((testimonialsProp, i) => {
                    return (
                        <div
                            ...
                            <p>
                                <span
                                    className={testimonialsProp.spanClassName}>
                                    {testimonialsProp.name}.
                            </span>
                                {testimonialsProp.position}.
                        </p>
                            <p>
                                {testimonialsProp.remarks}
                            </p>
                            <br />
                        </div>
                    )
...
class Skills extends Component {
    render() {
        ...
        return (
            <div>
                <h3
                    className={skillsProps.h3ClassName}>
                    {skillsProps.heading}
                </h3>
                {skillsProps.skillsPropsList.map((skillsProp, i) => {
                    return (
                        <div
                            ...
                            <div
                                className={skillsProp.divClassName}>
                                <div
...
class Profile extends Component {
    render() {
        ...
        return (
            <div>
                <h2
                    className={profileProps.h2ClassName}>
                    {profileProps.name}
                </h2>
                <hr
                    style={profileProps.hrStyle}
                    className={profileProps.hrClassName} />
                <p>
                    {profileProps.content}
                </p>
            </div>
        );
    }
    ...
    render() {
        return (
            <div
                ...
                <Plans planProps={planPropsLists} divClassName="w3-row-padding" divStyle={{ margin: 0 - 16 }} h3ClassName="w3-padding-16 w3-text-light-grey" heading="My Prices" />
